...
const IOS_AD_UNITS = {
  ...
  REWARDED_COACHING_SESSION: 'ca-app-pub-3170834290529005/9592041258',
...
const ANDROID_AD_UNITS = {
  ...
  REWARDED_COACHING_SESSION: TEST_REWARDED_ID,
...
export const AD_UNITS = {
  ...
  REWARDED_COACHING_SESSION: getAdUnitId('REWARDED_COACHING_SESSION'),
