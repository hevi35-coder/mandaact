              ...
              try {
                ...
                if (newlyUnlocked && newlyUnlocked.length > 0) {
                  ...
                  for (const badge of newlyUnlocked) {
                    ...
                    setTimeout(() => {
                      toast.success(`🏆 ${t('today.xp.newBadge')}`, `${t('badges.names.' + badge.badgeKey, badge.badgeTitle)} (+${badge.xpAwarded} XP)`)
        ...
        >
          ...
          {actions.length === 0 && (
            <ActiveEmptyState
              ...
              primaryActionLabel={t('today.empty.create')}
              secondaryActionLabel={t('today.empty.guide')}
