...
// 1. Watch monorepo files while preserving Expo defaults
// config.watchFolders already has Expo's defaults, we just add the workspace root
...
// 4. Custom resolver to handle workspace root entry point
