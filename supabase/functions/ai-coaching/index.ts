      ...
      return {
        [stepNum]: isEn ?
          ...
          `### Step ${stepNum}: 세부목표 ${subGoalNum} (딥다이브)
            ...
            2. **즉시 8개의 구체적인 실천항목을 정의하세요 (필수)**. 이 단계의 핵심은 세부목표와 함께 8개의 실천항목을 모두 제시하는 것입니다.
            3. **가독성 & 말풍선 분리**:
            ...
            4. **주의**: 세부목표는 8개가 끝입니다. ${isLast ? "**절대 '세부목표 9'를 언급하지 마세요.** 다음은 '비상 모드'입니다." : ""}
            5. **종료 조건**: 유저가 **동의(예: "좋아", "진행해")**하거나 내용을 확정하면, **즉시** "updated_draft"에 해당 세부목표와 **8개의 실천항목 전체**를 포함시키고, "next_step_ready": true와 "summary_data": {"new_sector": "세부목표 이름"}을 반환하세요.`
      };
