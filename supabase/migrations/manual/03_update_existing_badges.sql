-- Step 3: Update Existing Badges with Categories
...
-- Verify updates
SELECT key, title, category, tier, max_count FROM achievements ORDER BY display_order;
