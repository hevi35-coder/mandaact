-- Update evaluate_badge_progress function to support new badge condition types
-- Adds support for: perfect_month_count, midnight_checks, balanced_mandalart_week, time_range_checks
